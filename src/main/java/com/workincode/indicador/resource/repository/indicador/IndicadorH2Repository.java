...
@Repository
public interface IndicadorH2Repository
		extends
			JpaRepository<IndicadorRepositoryEntity, UUID> {
	@Query("SELECT b FROM IndicadorRepositoryEntity b JOIN FETCH b.series as bs WHERE b.codigo = :codigo AND bs.fecha =:fecha")
	 Optional<IndicadorRepositoryEntity> findByIndicador(@Param("codigo") String codigo,
